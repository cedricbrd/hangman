comment lancer le code : go run main/main.go ,espace, dictionnary/le fichier de mot que vous voulez parmis les librairies qui sont des fichiers au format .txt
